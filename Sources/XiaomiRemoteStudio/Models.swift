...
struct SmartAction: Identifiable {
    ...
    static let samples: [SmartAction] = [
        ...
        .init(id: "ai-reply", actionID: "smart-ai-reply", title: "AI 回复消息", subtitle: "选中文本后生成自然回复", symbol: "sparkles", tint: .purple, stepCount: 1),
        .init(id: "ai-grammar", actionID: "smart-ai-grammar", title: "AI 纠正语法", subtitle: "选中文本后检查语法与表达", symbol: "sparkles", tint: .purple, stepCount: 1),
        .init(id: "ai-summary", actionID: "smart-ai-summary", title: "AI 汇总文本", subtitle: "选中文本后生成要点摘要", symbol: "sparkles", tint: .purple, stepCount: 1),
